...
import NewTalkSection from '@components/new-talk-section';
...
export default function MeetingPage({ talk, siteSetting, parseConfig }: Props) {
  const meta = {
  ...
  return (
    <Page meta={meta}>
      <Layout siteSetting={siteSetting} parseConfig={parseConfig}>
        <NewTalkSection talk={talk} showTime={true} />
      </Layout>
    </Page>
  );
}
